...
const SignUp = ({ user }) => {
    ...
    return (
        <Container>
            ...
            <Content>
                <PunchLine>Staying connected to your customers is #1</PunchLine>

                <p>Are you open, delivering, or servicing curb-side?</p>

                <p>How do your customers know?</p>
                <PunchLine>
                    Invest in <span style={{ color: "#48679a" }}>Local</span>
                ...
                <p>
                    ...
                    <span style={{ color: "#848689" }}>Worx</span> number and
                    you engage via a live-chat screen.
                </p>
            </Content>
            ...
            <PricingContainer>
                <OneTimePrice>
                    ...
                    <p>
                        $20{" "}
                        <PricingSubtext>/month + $0.01 per sms</PricingSubtext>
                    </p>
                    <p> * Monthly subscription optional after 1,000 messages</p>
                    <Button
